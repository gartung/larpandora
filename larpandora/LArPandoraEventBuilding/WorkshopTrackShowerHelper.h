...
public:
     ...
     */
    static bool IsTrack(const art::Ptr<recob::PFParticle> &pfParticle, const PFParticlesToMetadata &pfParticleToMetadata, const float minTrackScore);
...
private:
     ...
     */
    static float GetTrackShowerScore(const art::Ptr<recob::PFParticle> &pfParticle, const PFParticlesToMetadata &pfParticleToMetadata);
};
